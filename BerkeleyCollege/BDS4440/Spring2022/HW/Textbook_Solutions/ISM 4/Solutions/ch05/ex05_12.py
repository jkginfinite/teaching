                ...
                for loop5 in range(3):
                    for loop6 in range(3):
                        for loop7 in range(3):
                            print(letters[digits[0]][loop1], end='')
                            print(letters[digits[1]][loop2], end='')
                            print(letters[digits[2]][loop3], end='')
                            print(letters[digits[3]][loop4], end='')
                            print(letters[digits[4]][loop5], end='')
                            print(letters[digits[5]][loop6], end='')
                            print(letters[digits[6]][loop7], end=' ')
